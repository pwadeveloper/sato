  ...
  return (
    <div ref={wrapper} className="relative">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={cn(
          "flex items-center gap-1.5 text-sm font-medium wdth-body",
      ...
      <div
        ...
        hidden={!open}
        className="
          absolute right-0 top-[calc(100%+0.85rem)] z-50 w-[min(44rem,calc(100vw-3rem))]
      ...
      >
        ...
        <Link
          href={href}
          onClick={() => setOpen(false)}
          className="mt-5 inline-block border-t border-rule-dark pt-4 text-xs font-medium text-brand-light no-underline underline-offset-[0.2em] wdth-body hover:underline"
        >
          <RichText text={label} />
        </Link>
      </div>
